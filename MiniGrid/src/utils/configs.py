...
class TrainingConfig():
    ...
    def init_logger(self, extra_args):
        ...
        for i in range(len(extra_args)):
            tmp = extra_args[i][2:] + ' '
            experiment_name = experiment_name + tmp
        # run_id_str = str(self.run_id) + experiment_name
        self.start_datetime = self.start_datetime + experiment_name

        # self.log_dir = os.path.join(self.log_dir, self.env_name, self.start_datetime, run_id_str)
