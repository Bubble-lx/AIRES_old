...
# print(current_dir)
# sys.path.append("/home/liuxinn/RLCLAL/self/learn_from_md/deir-main")
# sys.path.append("/deir")

# 获取当前文件的绝对路径
current_file_path = os.path.abspath(__file__)
current_dir = os.path.dirname(current_file_path)
parent_dir_of_parent = os.path.dirname(current_dir)
# print(parent_dir_of_parent)
...
def main(
    ...
    use_my_ratio, attn_selet_way, sequencelevel, ratio_s2aanda2s, attn_ratio_weight,

    seq_expl_len_mimex, decoder_depth_mimex, mask_ratio_mimex, use_cls_mimex, norm_loss_mimex, k_expl_mimex, n_mask_mimex,
    bert_lr_mimex, decoder_num_heads_mimex, anneal_k_mimex,

    log_dir, total_steps, features_dim, model_features_dim, learning_rate, model_learning_rate,
