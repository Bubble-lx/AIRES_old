...
# # 自己添加的---
register(
    id='MiniGrid-DoorKey-16x16-ViewSize-3x3-v0',
    entry_point='src.env.minigrid_envs:DoorKeyEnv16x16ViewSize3x3'
)
# # 自己添加的---
register(
...
# 自己添加---
class MultiRoomEnvN6V3(CustomMultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=6,
            maxNumRooms=6,
...
register(
    id='MiniGrid-MultiRoom-N6-ViewSize-3x3-v0',
    entry_point='src.env.minigrid_envs:MultiRoomEnvN6V3'
)
#
# class MultiRoomEnvN2S4(CustomMultiRoomEnv):
#     def __init__(self):
#         super().__init__(
#             minNumRooms=2,
#             maxNumRooms=2,
...
#     entry_point='src.env.minigrid_envs:MultiRoomEnvN2S4'
# )
# class MultiRoomEnvN6V3(CustomMultiRoomEnv):
#     def __init__(self):
#         super().__init__(
